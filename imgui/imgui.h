...
enum ImGuiStyleVar_
{
    ...
    ImGuiStyleVar_Scale,                       // float     Scale
...
struct ImDrawList
{
    ...
    IMGUI_API void AddTriangleCutout( const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, ImU32 col, float thickness = 1.0f );
